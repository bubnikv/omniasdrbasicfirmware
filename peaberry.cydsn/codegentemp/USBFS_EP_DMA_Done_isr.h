...
#define USBFS_EP_DMA_Done_isr_INTC_VECTOR            ((reg16 *) USBFS_EP_DMA_Done_isr__INTC_VECT)
...
#define USBFS_EP_DMA_Done_isr_INTC_SET_EN            ((reg8 *) USBFS_EP_DMA_Done_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the USBFS_EP_DMA_Done_isr interrupt. */
#define USBFS_EP_DMA_Done_isr_INTC_CLR_EN            ((reg8 *) USBFS_EP_DMA_Done_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the USBFS_EP_DMA_Done_isr interrupt state to pending. */
#define USBFS_EP_DMA_Done_isr_INTC_SET_PD            ((reg8 *) USBFS_EP_DMA_Done_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the USBFS_EP_DMA_Done_isr interrupt. */
#define USBFS_EP_DMA_Done_isr_INTC_CLR_PD            ((reg8 *) USBFS_EP_DMA_Done_isr__INTC_CLR_PD_REG)
