...
/*******************************************************************************
* Function Name: Iambic_Clock_1_Start
********************************************************************************
*
* Summary:
...
void Iambic_Clock_1_Start(void) 
{
    ...
    Iambic_Clock_1_CLKEN |= Iambic_Clock_1_CLKEN_MASK;
	Iambic_Clock_1_CLKSTBY |= Iambic_Clock_1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_Stop
********************************************************************************
*
* Summary:
...
void Iambic_Clock_1_Stop(void) 
{
    ...
    Iambic_Clock_1_CLKEN &= (uint8)(~Iambic_Clock_1_CLKEN_MASK);
	Iambic_Clock_1_CLKSTBY &= (uint8)(~Iambic_Clock_1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Iambic_Clock_1_CLKEN & Iambic_Clock_1_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Iambic_Clock_1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Iambic_Clock_1_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Iambic_Clock_1__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Iambic_Clock_1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Iambic_Clock_1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Iambic_Clock_1_GetSourceRegister();
    uint16 oldDivider = Iambic_Clock_1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Iambic_Clock_1_CLKEN & Iambic_Clock_1_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Iambic_Clock_1_DIV_PTR, clkDivider);
                Iambic_Clock_1_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Iambic_Clock_1_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Iambic_Clock_1_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Iambic_Clock_1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Iambic_Clock_1_DIV_PTR);
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Iambic_Clock_1_MOD_SRC |= modeBitMask & (uint8)Iambic_Clock_1_MODE_MASK;
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Iambic_Clock_1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Iambic_Clock_1_MODE_MASK));
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Iambic_Clock_1_MOD_SRC & (uint8)(Iambic_Clock_1_MODE_MASK);
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Iambic_Clock_1_GetDividerRegister();
    uint8 oldSrc = Iambic_Clock_1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Iambic_Clock_1_MOD_SRC |= CYCLK_SSS;
        Iambic_Clock_1_MOD_SRC =
            (Iambic_Clock_1_MOD_SRC & (uint8)(~Iambic_Clock_1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Iambic_Clock_1_MOD_SRC & Iambic_Clock_1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Iambic_Clock_1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Iambic_Clock_1_PHASE = clkPhase & Iambic_Clock_1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Iambic_Clock_1_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Iambic_Clock_1_PHASE & Iambic_Clock_1_PHASE_MASK;
}
