...
uint8 CW_Hold_Timer_initVar = 0u;


/*******************************************************************************
* Function Name: CW_Hold_Timer_Init
********************************************************************************
*
* Summary:
...
void CW_Hold_Timer_Init(void) 
{
        ...
        CW_Hold_Timer_CONTROL &= CW_Hold_Timer_CTRL_ENABLE;
        ...
        /* Clear the mode bits for continuous run mode */
            ...
            CW_Hold_Timer_CONTROL3 &= ((uint8)(~CW_Hold_Timer_CTRL_MODE_MASK));
        #endif /* CONTROL3 register exists only in PSoC3 OR PSoC5LP */

        /* Check if One Shot mode is enabled i.e. RunMode !=0*/
        #if (CW_Hold_Timer_RunModeUsed != 0x0u)
            /* Set 3rd bit of Control register to enable one shot mode */
            CW_Hold_Timer_CONTROL |= 0x04u;
        #endif /* One Shot enabled only when RunModeUsed is not Continuous*/

        #if (CW_Hold_Timer_RunModeUsed == 2)
            #if (CY_PSOC5A)
        ...
        #if (CW_Hold_Timer_UsingHWEnable != 0)
            #if (CY_PSOC5A)
        ...
        CW_Hold_Timer_RT1 &= ((uint8)(~CW_Hold_Timer_RT1_MASK));
        CW_Hold_Timer_RT1 |= CW_Hold_Timer_SYNC;

        /*Enable DSI Sync all all inputs of the Timer*/
        CW_Hold_Timer_RT1 &= ((uint8)(~CW_Hold_Timer_SYNCDSI_MASK));
        CW_Hold_Timer_RT1 |= CW_Hold_Timer_SYNCDSI_EN;

        /* Set the IRQ to use the status register interrupts */
        CW_Hold_Timer_CONTROL2 |= CW_Hold_Timer_CTRL2_IRQ_SEL;
    #endif /* Configuring registers of fixed function implementation */

    /* Set Initial values from Configuration */
    CW_Hold_Timer_WritePeriod(CW_Hold_Timer_INIT_PERIOD);
    CW_Hold_Timer_WriteCounter(CW_Hold_Timer_INIT_PERIOD);

    #if (CW_Hold_Timer_UsingHWCaptureCounter)/* Capture counter is enabled */
    ...
    CW_Hold_Timer_SetInterruptMode(CW_Hold_Timer_INIT_INTERRUPT_MODE);
}


/*******************************************************************************
* Function Name: CW_Hold_Timer_Enable
********************************************************************************
*
* Summary:
*  Enable the Timer
...
void CW_Hold_Timer_Enable(void) 
{
    ...
    #if (CW_Hold_Timer_UsingFixedFunction)
        CW_Hold_Timer_GLOBAL_ENABLE |= CW_Hold_Timer_BLOCK_EN_MASK;
        CW_Hold_Timer_GLOBAL_STBY_ENABLE |= CW_Hold_Timer_BLOCK_STBY_EN_MASK;
    #endif /* Set Enable bit for enabling Fixed function timer*/

    /* Remove assignment if control register is removed */
    #if (!CW_Hold_Timer_UDB_CONTROL_REG_REMOVED || CW_Hold_Timer_UsingFixedFunction)
        CW_Hold_Timer_CONTROL |= CW_Hold_Timer_CTRL_ENABLE;
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  CW_Hold_Timer_initVar: Is modified when this function is called for the
*   first time. Is used to ensure that initialization happens only once.
*
*******************************************************************************/
void CW_Hold_Timer_Start(void) 
{
    if(CW_Hold_Timer_initVar == 0u)
    {
        CW_Hold_Timer_Init();

        CW_Hold_Timer_initVar = 1u;   /* Clear this bit for Initialization */
    }
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_Stop
********************************************************************************
*
* Summary:
...
void CW_Hold_Timer_Stop(void) 
{
    /* Disable Timer */
    #if(!CW_Hold_Timer_UDB_CONTROL_REG_REMOVED || CW_Hold_Timer_UsingFixedFunction)
        CW_Hold_Timer_CONTROL &= ((uint8)(~CW_Hold_Timer_CTRL_ENABLE));
    #endif /* Remove assignment if control register is removed */

    /* Globally disable the Fixed Function Block chosen */
    #if (CW_Hold_Timer_UsingFixedFunction)
        CW_Hold_Timer_GLOBAL_ENABLE &= ((uint8)(~CW_Hold_Timer_BLOCK_EN_MASK));
        CW_Hold_Timer_GLOBAL_STBY_ENABLE &= ((uint8)(~CW_Hold_Timer_BLOCK_STBY_EN_MASK));
    #endif /* Disable global enable for the Timer Fixed function block to stop the Timer*/
}


/*******************************************************************************
* Function Name: CW_Hold_Timer_SetInterruptMode
********************************************************************************
*
* Summary:
...
{
    CW_Hold_Timer_STATUS_MASK = interruptMode;
}


/*******************************************************************************
* Function Name: CW_Hold_Timer_SoftwareCapture
********************************************************************************
*
* Summary:
...
void CW_Hold_Timer_SoftwareCapture(void) 
{
    ...
    #if(CW_Hold_Timer_UsingFixedFunction)
        (void)CY_GET_REG16(CW_Hold_Timer_COUNTER_LSB_PTR);
    #else
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_ReadStatusRegister
********************************************************************************
*
* Summary:
...
{
    return (CW_Hold_Timer_STATUS);
}


#if (!CW_Hold_Timer_UDB_CONTROL_REG_REMOVED) /* Remove API if control register is unused */


/*******************************************************************************
* Function Name: CW_Hold_Timer_ReadControlRegister
********************************************************************************
*
* Summary:
...
{
    #if (!CW_Hold_Timer_UDB_CONTROL_REG_REMOVED) 
        return ((uint8)CW_Hold_Timer_CONTROL);
    #else
        return (0);
    #endif /* (!CW_Hold_Timer_UDB_CONTROL_REG_REMOVED) */
}
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_WriteControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_ReadPeriod
********************************************************************************
*
* Summary:
...
{
   #if(CW_Hold_Timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(CW_Hold_Timer_PERIOD_LSB_PTR));
   #else
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_WritePeriod
********************************************************************************
*
* Summary:
...
void CW_Hold_Timer_WritePeriod(uint16 period) 
{
        ...
        CY_SET_REG16(CW_Hold_Timer_PERIOD_LSB_PTR, period_temp);
    #else
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_ReadCapture
********************************************************************************
*
* Summary:
...
{
   #if(CW_Hold_Timer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(CW_Hold_Timer_CAPTURE_LSB_PTR));
   #else
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_WriteCounter
********************************************************************************
*
* Summary:
...
void CW_Hold_Timer_WriteCounter(uint16 counter) 
{
         ...
         */
        CY_SET_REG16(CW_Hold_Timer_COUNTER_LSB_PTR, (uint16)counter);
...
/*******************************************************************************
* Function Name: CW_Hold_Timer_ReadCounter
********************************************************************************
*
* Summary:
...
#if(!CW_Hold_Timer_UsingFixedFunction) /* UDB Specific Functions */
