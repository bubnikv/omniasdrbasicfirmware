...
{
    #ifdef USBFS_EP_DMA_Done_isr_INTERRUPT_INTERRUPT_CALLBACK
        USBFS_EP_DMA_Done_isr_Interrupt_InterruptCallback();
    #endif /* USBFS_EP_DMA_Done_isr_INTERRUPT_INTERRUPT_CALLBACK */
    ...
    /* PSoC3 ES1, ES2 RTC ISR PATCH  */ 
        ...
        #if((CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2) && (USBFS_EP_DMA_Done_isr__ES2_PATCH ))      
            USBFS_EP_DMA_Done_isr_ISR_PATCH();
...
{
    CY_SET_REG16(USBFS_EP_DMA_Done_isr_INTC_VECTOR, (uint16) address);
}
...
{
    return (cyisraddress) CY_GET_REG16(USBFS_EP_DMA_Done_isr_INTC_VECTOR);
}
...
*
*   Note calling USBFS_EP_DMA_Done_isr_Start or USBFS_EP_DMA_Done_isr_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after USBFS_EP_DMA_Done_isr_Start or USBFS_EP_DMA_Done_isr_StartEx has been called. 
...
uint8 USBFS_EP_DMA_Done_isr_GetState(void) 
{
    ...
    return ((*USBFS_EP_DMA_Done_isr_INTC_SET_EN & (uint8)USBFS_EP_DMA_Done_isr__INTC_MASK) != 0u) ? 1u:0u;
}
